...
<div id="topProgressBar"
    class="fixed top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-blue-900 via-amber-500 to-blue-900 z-[9999] w-0 transition-all duration-300 ease-out pointer-events-none">
</div>

<!-- Fullscreen Loader Overlay: Bright & Crisp Academic Theme with soft light radial glow -->
<div id="pageLoader"
    class="fixed inset-0 bg-slate-50 z-[9998] flex flex-col items-center justify-center pointer-events-auto transition-opacity duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]">

    <!-- Soft Ambient Light Radial Glow in the center -->
    <div
        class="absolute w-[500px] h-[500px] bg-[radial-gradient(circle_at_center,rgba(30,58,138,0.04),transparent_65%)] pointer-events-none">
    </div>
