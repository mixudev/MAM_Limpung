{{--
  NOTE: Create these two files separately in your project:
  - resources/views/dashboard/guru.blade.php
  - resources/views/dashboard/siswa.blade.php

  Below is the content for guru.blade.php:
--}}
<!DOCTYPE html>
<html lang="id"><head><meta charset="UTF-8"><title>Guru Dashboard</title>
<style>body{font-family:system-ui,sans-serif;background:#f3f4f6;padding:2rem}.header{background:#92400e;color:#fff;padding:1.25rem 1.5rem;border-radius:.5rem;margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center}h1{font-size:1.1rem;font-weight:700}.card{background:#fff;padding:1.25rem;border-radius:.5rem;box-shadow:0 1px 3px rgba(0,0,0,.08);margin-bottom:1rem}.pill{display:inline-block;background:#fffbeb;color:#92400e;padding:.2rem .6rem;border-radius:9999px;font-size:.75rem;margin:.15rem}.logout-btn{background:rgba(255,255,255,.15);color:#fff;border:1px solid rgba(255,255,255,.3);padding:.375rem 1rem;border-radius:.375rem;cursor:pointer;font-size:.875rem}</style>
</head><body>
<div class="header">
...
<div class="card"><p>Selamat datang, <strong>{{ $user->name }}</strong>. Anda login sebagai <strong>Guru</strong>.</p></div>
</body></html>
