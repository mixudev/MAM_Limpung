...
<div class="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 shadow-sm">
    ...
    <div class="p-4 space-y-3">
        ...
        <div class="flex items-start gap-2"><svg class="w-4 h-4 shrink-0 mt-0.5 text-[#f59e0b]"
                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01" />
            </svg><span class="text-[11px] text-slate-600 dark:text-zinc-400">Baris tidak lengkap/salah ditandai warna kuning</span></div>
    </div>
</div>
