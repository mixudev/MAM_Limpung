    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="border border-slate-200 dark:border-zinc-700 p-5 flex flex-col justify-between hover:border-[#4f45b2]/40 transition-colors">
            <div>
                <div class="flex items-start justify-between gap-3 mb-2">
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        ...
                        @else
                        <span class="px-2 py-0.5 border border-emerald-200 text-emerald-700 text-[9px] font-bold font-mono uppercase bg-emerald-50 dark:bg-emerald-950/20 dark:border-emerald-800 dark:text-emerald-400">AKTIF</span>
                        @endif
                    </div>
                </div>
            ...
            <div class="flex justify-end gap-1.5 mt-4 pt-3 border-t border-slate-100 dark:border-zinc-800">
                <button type="button"
                    onclick="openKnowledgeModal(true, {{ json_encode(['id'=>$kb->id,'title'=>$kb->title,'content'=>$kb->content,'is_active'=>(int)$kb->is_active]) }})"
