                ...
                <div class="flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <div class="flex items-center justify-between border-t border-slate-100 dark:border-zinc-800 pt-3">
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('admin.announcements.ads.destroy', $ad) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus banner iklan ini?')">
                                @csrf
                                @method('DELETE')
