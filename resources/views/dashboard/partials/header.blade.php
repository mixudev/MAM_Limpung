<header
            ...
            <div class="flex-1 max-w-md relative">
                ...
                <input id="searchInput" type="text" placeholder="Search users, apps, logs..."
                    ...
                    class="w-full pl-9 pr-4 py-2 text-sm bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-none text-slate-700 dark:text-zinc-300 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400/30 focus:border-blue-500"
