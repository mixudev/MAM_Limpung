...
class StoreGaleriRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create-galeri');
    }
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if (! $hasPhotos && ! $hasLinks) {
                $validator->errors()->add('photos', 'Harus mengunggah minimal satu foto atau menyertakan satu tautan foto.');
            }
        });
    }
