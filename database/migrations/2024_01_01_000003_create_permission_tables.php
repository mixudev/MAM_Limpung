...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->string('group')->nullable()->comment('Grouping permissions e.g. users, courses, grades');
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            ...
            $table->string('display_name')->nullable();
            $table->text('description')->nullable();
            $table->integer('level')->default(0)->comment('Hierarchy level: higher = more privileged');
            $table->timestamps();
        ...
        // Model has permissions (direct permission assignment)
